...
public class vendingController {
	...
	ArrayList<Pair<Button, Label>> buttons = new ArrayList<Pair<Button, Label>>();
	...
	public void initializeItemButtons() {
		...
		buttons.add(new Pair<Button, Label>(item1, qty1));
		buttons.add(new Pair<Button, Label>(item2, qty2));
		buttons.add(new Pair<Button, Label>(item3, qty3));
		buttons.add(new Pair<Button, Label>(item4, qty4));
		buttons.add(new Pair<Button, Label>(item5, qty5));
		buttons.add(new Pair<Button, Label>(item6, qty6));
		buttons.add(new Pair<Button, Label>(item7, qty7));
		buttons.add(new Pair<Button, Label>(item8, qty8));
